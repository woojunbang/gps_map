...
coords_data <- read.csv('/Users/woojunbang/Desktop/Korean_mosquiotes_2024/Aedes_flavopictus_gps_coordinates.csv', header=TRUE)
...
# JPG로 저장
ggsave(filename = "/Users/woojunbang/Desktop/Korean_mosquiotes_2024/Aedes_flavopictus_coordinates_plot.jpg", 
